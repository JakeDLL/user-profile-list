...
function showPage(list, page) {
   //used 9 for the number of students to be displayed at a time
   const startIndex = (page * 9) - 9;
   const endIndex = page * 9;

   // this resets the studentList
   studentList.innerHTML = '';

   // the for loop iterates throw the list of student objects and creates a student list item and adds it to the studentList HTML
   for (let i = 0; i < list.length; i++) {
...
function addPagination(list) {
   ...
   // The loop creates the buttons necessary to navigate the pages and adds them to the button list
...
// to dynamically display the fitlered list of students
